...
```bash
python ~/.workbuddy/skills/video-lapian/scripts/extract_frames.py "video.mp4" --out "{视频名}_分析"
```

3. 生成总览图：

```bash
python ~/.workbuddy/skills/video-lapian/scripts/generate_overview.py "{视频名}_分析/关键帧" --out "{视频名}_分析/视频总览图.jpg" --title "视频总览"
python ~/.workbuddy/skills/video-lapian/scripts/generate_overview.py "{视频名}_分析/分镜详解" --out "{视频名}_分析/分镜总览图.jpg" --title "分镜总览"
```
...
```bash
python ~/.workbuddy/skills/video-lapian/scripts/generate_html.py "{视频名}_分析/完整分析报告.md" --out "{视频名}_分析/完整分析报告.html"
```

7. 打包图片：

```bash
python ~/.workbuddy/skills/video-lapian/scripts/generate_zip.py "{视频名}_分析" --out "{视频名}_分析/分析图片.zip"
```
